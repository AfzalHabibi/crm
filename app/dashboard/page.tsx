    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800">
          <CardHeader>
            <CardTitle className="text-blue-900 dark:text-blue-100">🎉 Welcome to Your DepLLC CRM</CardTitle>
            <CardDescription className="text-blue-700 dark:text-blue-300">
              Your CRM system is now set up and ready to use. Here are some next steps to get you started:
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="grid gap-3 md:grid-cols-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-blue-800 dark:text-blue-200">Explore the user management system</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                  2
                </div>
                <span className="text-sm text-blue-800 dark:text-blue-200">Set up your company profile</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                  3
                </div>
                <span className="text-sm text-blue-800 dark:text-blue-200">Import your existing contacts</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                  4
                </div>
                <span className="text-sm text-blue-800 dark:text-blue-200">Configure your sales pipeline</span>
              </div>
            </div>
          </CardContent>
        </Card>
